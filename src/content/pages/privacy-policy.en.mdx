...
6. **Submitted URLs** — Public video page URLs you ask us to parse. We do not routinely save successful anonymous submissions in our application database, but security logs and upstream providers may process request data for reliability and abuse prevention.
...
- Send submitted public URLs to configured parsing providers so they can return media information.
...
- With parsing providers when necessary to process a URL you submit.
