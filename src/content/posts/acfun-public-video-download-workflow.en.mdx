export const meta = {
  title: 'AcFun downloader workflow for public public creator videos',
  description:
    'A practical workflow for processing public AcFun links, checking parser results, and keeping source records for creator teams.',
...
This guide focuses on manual downloader for AcFun. It is written for creators, editors, social media managers, researchers, and automation teams who work with public public creator videos. Only process content you own, have permission to use, or have another lawful basis to handle.
